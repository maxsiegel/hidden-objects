...
ffmpeg -hide_banner -y -i  temp/horizontal_border_and_time_padded.mp4 -hide_banner -i temp/time_border_padded_A.mp4 -hide_banner -i  temp/time_border_padded_B.mp4 -filter_complex "[1][2]hstack=inputs=2[p2];[0][p2]vstack=inputs=2" $OUT_FNAME
